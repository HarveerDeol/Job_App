...
export default function JobDetailPage() {
  ...
  const [education, setEducation] = useState([
    { school: "", degree: "", field: "", graduationDate: "", location: "" }
  ]);
...
useEffect(() => {
  ...
  const addExperience = () => {
    setExperiences([...experiences, { company: "", title: "", startDate: "", endDate: "", description: "", location:"" }]);
  };
  ...
  const addEducation = () => {
    setEducation([...education, { school: "", degree: "", field: "", graduationDate: "", location:"" }]);
  };
